...
public class Sprite {
    ...
    public void paint(Canvas canvas, Paint paint) {
        ...
        Bitmap bitmap = Bitmap
                .createBitmap(this.bigFrames, this.framesXY[currentPosition][0], this.framesXY[currentPosition][1], this.frameWidth, this.frameHeight);
        canvas.drawBitmap(bitmap, PositionX, PositionY, paint);
    }
    
    @Override
    public String toString() {
        return "Sprite [length=" + length + ", currentPosition=" + currentPosition + ", framesXY=" + Arrays
                .toString(framesXY) + ", frameWidth=" + frameWidth + ", frameHeight=" + frameHeight + ", bigFrames=" + bigFrames + ", cols=" + cols + ", rows=" + rows + ", PositionX=" + PositionX + ", PositionY=" + PositionY + ", frameSequence=" + Arrays
                .toString(frameSequence) + ", sequencePosition=" + sequencePosition + "]";
    }
}